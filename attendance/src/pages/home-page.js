...
const HomePage = () => {
    ...
    console.log(isLoggedIn, authData)
    ...
    return (
        <div className={styles.myContainer}>
            <div className={styles.header}>
                ...
                {
                    isLoggedIn ? <span>{authData.username}</span> : <Button color="secondary" sx={{width: '130px', color: 'white'}} onClick={handleClickLogin}>Đăng nhập</Button>
                }
                <Button color="secondary" sx={{width: '130px', color: 'white'}} onClick={handleClickRegister}>Đăng kí</Button>
            </div>
            ...
            <LoginPage open={openLogin} setOpen={setOpenLogin}></LoginPage>
